{
  ...
  spec: {
    ...
    appRole: {
      ...
      '#withSecretRef':: d.fn(help="\"SecretRef is the name of a Kubernetes secret in the consumer's (VDS/VSS/PKI) namespace which provides the AppRole Role's SecretID. The secret must have a key named `id` which holds the AppRole Role's secretID.\"", args=[d.arg(name='secretRef', type=d.T.string)]),
    ...
    aws: {
      ...
      '#withIrsaServiceAccount':: d.fn(help='"IRSAServiceAccount name to use with IAM Roles for Service Accounts (IRSA), and should be annotated with \\"eks.amazonaws.com/role-arn\\". This ServiceAccount will be checked for other EKS annotations: eks.amazonaws.com/audience and eks.amazonaws.com/token-expiration"', args=[d.arg(name='irsaServiceAccount', type=d.T.string)]),
    ...
    gcp: {
      '#withClusterName':: d.fn(help="\"GKE cluster name. Defaults to the cluster-name returned from the operator pod's local metadata server.\"", args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { spec+: { gcp+: { clusterName: clusterName } } },
      '#withProjectID':: d.fn(help="\"GCP project ID. Defaults to the project-id returned from the operator pod's local metadata server.\"", args=[d.arg(name='projectID', type=d.T.string)]),
      withProjectID(projectID): { spec+: { gcp+: { projectID: projectID } } },
      '#withRegion':: d.fn(help="\"GCP Region of the GKE cluster's identity provider. Defaults to the region returned from the operator pod's local metadata server.\"", args=[d.arg(name='region', type=d.T.string)]),
      withRegion(region): { spec+: { gcp+: { region: region } } },
      '#withRole':: d.fn(help='"Vault role to use for authenticating"', args=[d.arg(name='role', type=d.T.string)]),
      withRole(role): { spec+: { gcp+: { role: role } } },
      '#withWorkloadIdentityServiceAccount':: d.fn(help='"WorkloadIdentityServiceAccount is the name of a Kubernetes service account (in the same Kubernetes namespace as the Vault*Secret referencing this resource) which has been configured for workload identity in GKE. Should be annotated with \\"iam.gke.io/gcp-service-account\\"."', args=[d.arg(name='workloadIdentityServiceAccount', type=d.T.string)]),
    ...
    jwt: {
      ...
      '#withSecretRef':: d.fn(help="\"SecretRef is the name of a Kubernetes secret in the consumer's (VDS/VSS/PKI) namespace which provides the JWT token to authenticate to Vault's JWT authentication backend. The secret must have a key named `jwt` which holds the JWT token.\"", args=[d.arg(name='secretRef', type=d.T.string)]),
      withSecretRef(secretRef): { spec+: { jwt+: { secretRef: secretRef } } },
      '#withServiceAccount':: d.fn(help="\"ServiceAccount to use when creating a ServiceAccount token to authenticate to Vault's JWT authentication backend.\"", args=[d.arg(name='serviceAccount', type=d.T.string)]),
    ...
    '#withAllowedNamespaces':: d.fn(help="\"AllowedNamespaces Kubernetes Namespaces which are allow-listed for use with this AuthMethod. This field allows administrators to customize which Kubernetes namespaces are authorized to use with this AuthMethod. While Vault will still enforce its own rules, this has the added configurability of restricting which VaultAuthMethods can be used by which namespaces. Accepted values: []{\\\"*\\\"} - wildcard, all namespaces. []{\\\"a\\\", \\\"b\\\"} - list of namespaces. unset - disallow all namespaces except the Operator's the VaultAuthMethod's namespace, this is the default behavior.\"", args=[d.arg(name='allowedNamespaces', type=d.T.array)]),
