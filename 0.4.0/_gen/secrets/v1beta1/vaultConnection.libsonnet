{
  ...
  '#':: d.pkg(name='vaultConnection', url='', help='"VaultConnection is the Schema for the vaultconnections API"'),
  ...
  '#new':: d.fn(help='new returns an instance of VaultConnection', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'secrets.hashicorp.com/v1beta1',
    kind: 'VaultConnection',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VaultConnectionSpec defines the desired state of VaultConnection"'),
  spec: {
