{
  ...
  spec: {
    ...
    '#withAllowStaticCreds':: d.fn(help='"AllowStaticCreds should be set when syncing credentials that are periodically\\nrotated by the Vault server, rather than created upon request. These secrets\\nare sometimes referred to as \\"static roles\\", or \\"static credentials\\", with a\\nrequest path that contains \\"static-creds\\"."', args=[d.arg(name='allowStaticCreds', type=d.T.boolean)]),
