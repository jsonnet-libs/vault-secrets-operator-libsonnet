{
  ...
  '#':: d.pkg(name='vaultStaticSecret', url='', help='"VaultStaticSecret is the Schema for the vaultstaticsecrets API"'),
  ...
  '#new':: d.fn(help='new returns an instance of VaultStaticSecret', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
    apiVersion: 'secrets.hashicorp.com/v1beta1',
    kind: 'VaultStaticSecret',
  } + self.metadata.withName(name=name),
  '#spec':: d.obj(help='"VaultStaticSecretSpec defines the desired state of VaultStaticSecret"'),
  spec: {
    ...
    '#withHmacSecretData':: d.fn(help="\"HMACSecretData determines whether the Operator computes the HMAC of the Secret's data. The MAC value will be stored in the resource's Status.SecretMac field, and will be used for drift detection and during incoming Vault secret comparison. Enabling this feature is recommended to ensure that Secret's data stays consistent with Vault.\"", args=[d.arg(name='hmacSecretData', type=d.T.boolean)]),
    ...
    '#withVersion':: d.fn(help='"Version of the secret to fetch. Only valid for type kv-v2. Corresponds to version query parameter: https://developer.hashicorp.com/vault/api-docs/secret/kv/kv-v2#version"', args=[d.arg(name='version', type=d.T.integer)]),
